...
<footer class="text-gray-400 bg-gray-900 body-font absolute left-0 right-0 bottom-0 lg:px-[5rem]">
  <div class="container lg:py-8 py-2 mx-auto flex items-center sm:flex-row flex-col ">
    ...
    <p class="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4">© 2023 InkFinder —
      <a href="https://github.com/fdsssawe" class="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">Zhovanyk Olexander</a>
    </p>
