    ...
    return(
        <section class="text-white bg-gray-900 dark:[color-scheme:dark] min-h-screen pb-[100px] max-w-full overflow-hidden">
            <div class="container mx-auto flex px-5 pt-32 lg:flex-row flex-col items-end lg:mb-[18rem] mb-12">
                ...
                <p class="mb-4 leading-relaxed text-[1.238rem] lg:h-[6.563rem] lg:w-[37.688rem] font-normal">
                ...
                className="text-white lg:text-[1.438rem] leading-relaxed bg-green-500 border-0 py-2 lg:px-4 md:px-1 sm:px-1 focus:outline-none hover:bg-green-600 rounded text-lg lg:w-[11.2rem] lg:h-[3.063rem] flex items-center">
                Start Browsing
                </button>
                </div>
                </div>
            ...
            <div class={`container mx-auto flex px-5 lg:flex-row flex-col items-center ${cl.hidden} ${inView ? cl.showed : ""}`} ref={ref}>
                <div class="flex lg:justify-start md:justify-center w-full items-center h-full">
                        <img  className='max-h-[467.99px] max-w-[600px]' alt="hero" src={homepicture1}></img>
                </div>
                <div class="h-[384px] lg:w-[55%] lg:pl-24 flex flex-col lg:items-start md:text-left items-center text-center lg:mb-8 ">
                <div class="lg:text-[4.688rem] leading-[5.313rem] font-bold lg:h-[12.375rem] lg:w-[43.625rem] text-3xl text-gray-900">
                Design generator powered by AI
                </div>
                <p class="mb-4 leading-relaxed text-[1.238rem] lg:h-[6.563rem] lg:w-[37.688rem] font-normal text-gray-900">
            ...
            <div class="flex lg:justify-end justify-center w-full items-end lg:h-1/2 ">
                <div class="lg:h-[18.063rem] lg:w-[43.625rem] w-full lg:pr-24 flex flex-col lg:items-start md:text-left  items-center text-center lg:mb-8" >
                    <div class=" lg:text-[4.688rem] leading-[5.313rem] font-bold  text-white lg:h-[12.75rem] lg:w-[43.625rem] text-3xl">
            ...
            <div className='h-full w-full'>
                ...
                <img  className='max-h-[823.34px] max-w-[700px]' alt="hero" src={homepicture3}></img>
                </div>
            </div>
            </div>
            </div>
