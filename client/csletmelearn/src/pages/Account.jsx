...
const Account = () => {
    ...
    return (
        ...
        <svg className='' width="120" height="120" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={() => navigate(`/account/${userPosts?.data?.profileOwner._id}`)}>
